...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form input"),r=document.querySelector(".feedback-form textarea"),o=document.querySelector(".feedback-form"),l="feedback-form-state",u={message:r.value,email:a.value};function n(e){u[e.target.name]=e.target.value,console.log(u),localStorage.setItem(l,JSON.stringify(u))}function c(){const e=JSON.parse(localStorage.getItem(l));e&&(r.value=e.message,a.value=e.email)}function s(e){if(e.preventDefault(),""===r.value||""===a.value)return alert("please fill the form");console.log("submited:",u),e.currentTarget.reset(),localStorage.removeItem(l)}o.addEventListener("submit",s),o.addEventListener("input",(0,e.default)(n,500)),c();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.06293086.js.map