...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const o=document.querySelector(".feedback-form input"),r=document.querySelector(".feedback-form textarea"),n=document.querySelector(".feedback-form"),a="feedback-form-state",u={};function c(){localStorage.setItem(a,JSON.stringify(u))}function l(){const e=JSON.parse(localStorage.getItem(a));e&&(console.log(e),u.value)}function d(e){e.preventDefault(),e.currentTarget.reset(),localStorage.removeItem(a),console.log("submited")}o.addEventListener("input",(0,e.default)(c,500)),r.addEventListener("input",(0,e.default)(c,500)),n.addEventListener("submit",d),n.addEventListener("input",e=>{u[e.target.name]=e.target.value,console.log(u)}),l();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.0cf5d2be.js.map