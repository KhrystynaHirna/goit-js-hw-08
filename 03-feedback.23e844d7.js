...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const o=document.querySelector("input"),r=document.querySelector("textarea"),n=document.querySelector("form");function a(e){const t=e.currentTarget.value;console.log(t),localStorage.setItem("feedback-form-state",t)}function c(e){const t=localStorage.getItem("feedback-form-state");t&&(console.log(t),o.value=t)}function u(e){const t=e.currentTarget.value;console.log(t),localStorage.setItem("feedback-form-state",t)}function l(e){e.preventDefault(),e.currentTarget.reset(),console.log("submited")}o.addEventListener("input",a),r.addEventListener("textarea",u),n.addEventListener("submit",l),c();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.23e844d7.js.map