...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form input"),o=document.querySelector(".feedback-form textarea"),r=document.querySelector(".feedback-form"),l="feedback-form-state";function n(e){const t={message:o.value,email:a.value};t[e.target.name]=e.target.value,console.log(t),localStorage.setItem(l,JSON.stringify(t))}function u(){const e=JSON.parse(localStorage.getItem(l));e&&(o.value=e.message||"",a.value=e.email||"")}function c(e){e.preventDefault();const t=JSON.parse(localStorage.getItem(l));if(console.log(t),""===o.value||""===a.value)return alert("please fill the form");console.log("submited:",t),e.currentTarget.reset(),localStorage.removeItem(l)}r.addEventListener("submit",c),r.addEventListener("input",(0,e.default)(n,500)),u();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.64ad9c59.js.map